                                    ...
                                    return (
                                        ...
                                        <div className="xl:w-1/3 md:w-1/2 p-4 overflow-hidden shadow-lg hover:scale-105 transition duration-500 cursor-pointer" key={index}>
                                            <div className="bg-white p-6 rounded-lg">
                                                ...
                                                <h2 className="tracking-widest text-indigo-500 text-base font-medium title-font">   {post.title}</h2>
                                                <a href={`/blog/${post._id}`}> <h2 className="text-base text-gray-900 font-medium title-font mb-4">{post.content}</h2></a>
